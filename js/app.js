...
const defaultDB = {
  ...
  products: [
    ...
    { id: 'p29', name: 'Secretlab Titan Gaming Chair', category: 'Furniture', image: 'https://images.unsplash.com/photo-1598550476439-6847785fce6e?q=80&w=400&auto=format&fit=crop', price: 150, description: 'Award-winning ergonomic gaming and office chair.', stock: 30, holdHours: 12, profitPercent: 50 },
    { id: 'p30', name: 'Steam Deck OLED', category: 'Gaming', image: 'https://images.unsplash.com/photo-1662970710609-b148d4cb8001?q=80&w=400&auto=format&fit=crop', price: 140, description: 'Handheld gaming computer with vibrant 7.4" OLED screen.', stock: 35, holdHours: 12, profitPercent: 48 },
    { id: 'p31', name: 'Gucci Belt', category: 'Fashion', image: 'https://images.unsplash.com/photo-1624222247344-550fb8ecf7db?q=80&w=400&auto=format&fit=crop', price: 180, description: 'Luxury leather belt with double G buckle.', stock: 20, holdHours: 12, profitPercent: 55 },
